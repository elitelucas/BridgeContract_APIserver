...
const web3Eth = new Web3("wss://rinkeby.infura.io/ws/v3/7de28753810e4400b3eb7fccf288475b");
const web3Bsc = new Web3(new Web3.providers.HttpProvider("https://data-seed-prebsc-1-s1.binance.org:8545"));
const adminPrivKey =
...
const BridgeEthAddress = "0x7778dc743937d1573C651DA0602Fa9Cd04755A8A";
const BridgeBscABI = [
	{
		"inputs": [],
		"stateMutability": "nonpayable",
...
const BridgeBscAddress = "0xFE78Aadf394E02e13E59c4322449693B3EEED2dD";
...
bridgeEth.events.Convert(async (err, events) => {
  if (err) {
    ...
    const tx = bridgeBsc.methods.withdraw(to, amount);
    const [gasPrice, gasCost] = await Promise.all([
      web3Bsc.eth.getGasPrice(),
      tx.estimateGas({ from: admin }),
    ]);
